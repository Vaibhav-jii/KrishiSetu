...
async def run_report_agent(state: KisanMindState) -> KisanMindState:
    ...
    try:
        ...
        return {
            "final_report": f"# KrishiSetu Report\n\nReport generation failed: {e}",
            "agent_times": agent_times,
            "errors": errs,
        }
...
def _build_report(query, crop_type, location, disease, market, scheme, weather, errors):
    ...
    # ── Header ──
    sections.append("# 🌾 KrishiSetu Advisory Report / कृषिसेतु सलाहकार रिपोर्ट\n")
    ...
    # ── Footer ──
    sections.append("---")
    sections.append("*Report generated by KrishiSetu AI Advisory System*")
